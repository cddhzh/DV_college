<template>
    <el-container>
        <el-aside width="20%">
            <el-header style="background-color: #C23531; font-size: 20px">
                <font color="#f0f8ff" style="position: relative; top: 10px;">数据筛选</font>
            </el-header>
            <div style="width: 99%">
                <br>
                <el-upload
...
<!--                    </el-button>-->
                ...
                <br>
                <div v-if="this.upSuccess">{{this.filename}}</div>
                <br>
                ...
                <br><br>
                <el-select style="width: 90%" v-model="major" placeholder="请选择专业" @change="getSubject">
                    <el-option
        ...
        <div style="width: 80%">
            <el-header style="background-color: #C23531; font-size: 20px;">
                <font color="#f0f8ff" style="position: relative; top: 10px;">请选择学院与专业进行实验</font>
            </el-header>
            <div>
                <el-table
            ...
            this.file2Xce(file).then(tabJson => {
                if (tabJson && tabJson.length > 0) {
                    ...
                    for (const Key in _this.tableData) {
                        ...
                        major_set.add(_this.tableData[Key].专业)
                    }
                    ...
                    sessionStorage.setItem("majors", JSON.stringify(Array.from(major_set)))
